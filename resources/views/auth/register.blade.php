            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('usuarios.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="rol"
                                    class="form-control @error('rol') is-invalid @enderror" name="rol" required>
                        ...
                        <div class="row mb-3">
                            <label for="procesos" class="col-md-4 col-form-label text-md-end">{{ __('Procesos')
                                }}</label>

                            <div class="col-md-6">
                                <div class="form-control">
                                    <div>
                                        <input type="checkbox" id="Evaluacion y control" name="procesos[]"
                                            value="Evaluacion y control" />
                                        <label for="Evaluacion y control">Evaluación & control</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="Gestion estrategica" name="procesos[]"
                                            value="Gestion estrategica" />
                                        <label for="Gestion estrategica">Gestión estratégica</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="Gobierno corporativo" name="procesos[]"
                                            value="Gobierno corporativo" />
                                        <label for="Gobierno corporativo">Gobierno corporativo</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="Gestion proyectos operaciones" name="procesos[]"
                                            value="Gestion proyectos operaciones" />
                                        <label for="Gestion proyectos operaciones">Gestión proyectos operaciones</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="Gestion comercial" name="procesos[]"
                                            value="Gestion comercial" />
                                        <label for="Gestion comercial">Gestión comercial</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="Gestion administrativa y financiera"
                                            name="procesos[]" value="Gestion administrativa y financiera" />
                                        <label for="Gestion administrativa y financiera">Gestión administrativa &
                                            financiera</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="Innovacion y tecnologia" name="procesos[]"
                                            value="Innovacion y tecnologia" />
